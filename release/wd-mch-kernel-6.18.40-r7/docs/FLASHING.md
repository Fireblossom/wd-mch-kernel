...
dd if=/dev/sda1 of=/data/wd-mch-backup/fw_table-before-r7.bin
dd if=/dev/sda6 of=/data/wd-mch-backup/fdt-b-before-r7.img
dd if=/dev/sda8 of=/data/wd-mch-backup/kernel-b-before-r7.img
sync
```
...
> （`cmp -l flash/fw_table.bin /data/wd-mch-backup/fw_table-before-r7.bin`，

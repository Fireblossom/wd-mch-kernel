...
| `v31` | 可以稳定启动并从串口登录 | 单核、UART 轮询的早期稳态；对应 Git 基线 `e8a2ab50f` |
| `v32` | 修正 CPU release-address 访问，四个 Cortex-A53 核心上线 | SMP 里程碑，提交 `0406c4e6c` |
| `v34` | RTD129x interrupt mux 和 UART 真中断稳定工作 | UART 里程碑，提交 `cc2bb90b4` |
| `v36` | 板载千兆以太网工作，并读取出厂 MAC | 网络里程碑，提交 `28b333771` |
| `v38` | 加入 NFS/ACL/配额、TUN/WireGuard、dm-crypt、FUSE、zram，并实现软重启 | NAS 功能里程碑，提交 `310a7687b` |
| `v42` | USB 3.0 以 5 Gbit/s 工作，加入温度驱动和 RTC 节点，完成安全收尾 | 完整日常功能里程碑，提交 `a3d1a698a` |
| `v46` | 加入 A/B/GOLD 槽位控制和一次性网络救援 | **r1 的直接技术基础**，提交 `aeae8812a` |
